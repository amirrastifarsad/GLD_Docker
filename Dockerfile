...
CMD ["sh", "-c", "nohup usr/bin/husarnet-daemon & ; sleep 5;usr/bin/husarnet join fc94:b01d:1803:8dd8:b293:5c7d:7639:932a/HwfD2KFoTHQbSyTrhErzqu render-the-ai ; glider -listen \"[::]:8099?auth=${PROXY_USER}:${PROXY_PASS}\" -verbose"]
